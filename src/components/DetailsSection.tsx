      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">        
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">            
            ...
            <div className="px-4 sm:px-6 py-2 border border-white text-white rounded-full text-xs mb-4">
            ...
            border: "1px solid #ECECEC"
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                  <button 
                    type="submit" 
                    className="w-full px-6 py-3 bg-pulse-500 hover:bg-pulse-700 text-white font-medium rounded-full transition-colors duration-300"
                  >
                    Request access
                  </button>
                </div>
