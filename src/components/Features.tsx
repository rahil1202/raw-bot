...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    <div 
      ref={cardRef}
      className={cn(
        "feature-card glass-card bg-opacity-100 p-4 sm:p-6",
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        ...
        <div className="flex items-center gap-4 mb-8 sm:mb-16">
          <div className="flex items-center gap-4">
            <div className="pulse-chip">
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-pulse-500 text-white mr-2">05</span>
              <span>Features</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-6">
          <GlowCard
           glowColor="blue"
           className="w-70 feature-card glass-card opacity-10 fade-in-element h-70"
           >
          <FeatureCard
            ...
            description="Raw-Bot learns from your interactions, continuously improving its responses and actions to better serve your needs."
            index={0}
          />
          </GlowCard>
          <GlowCard
          ...
          <FeatureCard
            ...
            description="Communicate using natural language and gestures. Raw-Bot understands context and responds appropriately."
            index={1}
          />
          </GlowCard>
          <GlowCard
          ...
          <FeatureCard
            ...
            description="Advanced sensors and mapping technology allow Raw-Bot to navigate complex environments with ease."
            index={3}
          />
          </GlowCard>
          <GlowCard
          ...
          <FeatureCard
            ...
            description="From simple reminders to complex multi-step tasks, Raw-Bot can assist with a wide range of activities."
            index={5}
          />
          </GlowCard>
        </div>
