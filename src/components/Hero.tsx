      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Raw-Bot: Coded as<br className="hidden sm:inline" />Human
            </h1>
            ...
            >
              The human like companion that learns and adapts alongside you.
            </p>
          ...
          <div className="w-full lg:w-[120%] relative mt-6 lg:mt-0">           
              <div className="absolute inset-0 bg-dark-900 rounded-2xl sm:rounded-3xl -z-10 shadow-lg"></div>
              <div className="relative transition-all duration-300 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-lg">
