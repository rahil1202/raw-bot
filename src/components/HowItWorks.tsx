...
const HowItWorks = () => {
  ...
  const stepsData = [
    ...
    },
    {
      ...
      description: "We'll work with you to customize Raw-Bot to your specific needs and preferences.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Integration",
      description: "Raw-Bot arrives at your location and is integrated into your living or working environment.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Adaptation",
      description: "Through daily interaction, Raw-Bot learns and adapts to your routines, preferences, and needs.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
  ...
  return (
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-100 fade-in-stagger">
          <div className="pulse-chip mx-auto mb-4">
            <span>Process</span>
          </div>
          <h2 className="section-title mb-4">How Raw-Bot Integrates Into Your Life</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-4 order-2 lg:order-1 opacity-100 fade-in-stagger">
          ...
          <div className="relative rounded-3xl overflow-hidden h-[400px] shadow-elegant order-1 lg:order-2 opacity-100 fade-in-stagger">
            {stepsData.map((step, index) => (
              <div
                key={index}
                className={cn(
